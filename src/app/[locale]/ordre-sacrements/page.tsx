            ...
            <section className='h-[25vh] md:h-[50vh] w-full relative bg-gray-200'>
                ...
                <div className='absolute inset-0 flex justify-center items-start bg-black bg-opacity-40'>
                    <div className='w-full h-full flex flex-col justify-center items-center'>
                        <h1 className='heading-2 text-center text-white font-extrabold'>Le sacrement de l'ordre</h1>
                        <p className='body-2 text-center text-white mt-3'>Comprendre les trois degrés : évêque, prêtre et diacre</p>
                    </div>
                </div>
            </section>
