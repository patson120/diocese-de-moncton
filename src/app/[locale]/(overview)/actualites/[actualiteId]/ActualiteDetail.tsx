        ...
        <div className='col-span-full lg:col-span-4'>
            ...
            <div className='container max-margin pt-4 md:pt-0 md:px-0 md:mx-0 flex flex-col space-y-3'>
                <div className='flex justify-between pt-4'>
                    ...
                    <p className='text-gray-400 body-3'><Text keyString="publier_le" /> {formatDateToLocal(actualite?.date_publication ? actualite?.date_publication : actualite?.created_at)}</p>
                </div>
